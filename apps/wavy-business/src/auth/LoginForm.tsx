  ...
  return (
    <div className="mx-auto max-w-sm rounded-2xl bg-neutral-900 p-6">
      ...
      <p className="mb-4 text-sm text-neutral-400">
        Melde dich mit deinem Organizer-Konto an, um Events anzulegen und zu verwalten.
      </p>
      ...
      {step === 'register' && (
        <form onSubmit={handleRegisterSubmit} className="space-y-3">
          ...
          <p className="rounded-lg border border-amber-900 bg-amber-950/40 p-2 text-xs text-amber-200">
            Ein neues Konto hat noch keinen Organizer-Zugang. Nach dem Anlegen wende dich an
            den Support, um die Rolle freischalten zu lassen.
          </p>
          <input
            type="password"
            required
