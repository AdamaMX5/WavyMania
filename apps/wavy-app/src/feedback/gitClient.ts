...
// domain already (same rationale as authClient.ts/reputationClient.ts) — hardcoded
// default URL, overridable via VITE_GIT_SERVICE_URL (root .env).
...
// here, unlike the optional-auth guest-checkout clients (ticketClient.buyTicket etc.).
